...
export default function Home() {
  return (
    <>
      <header className="relative bg-gradient-to-br from-slate-900 via-brand-900 to-slate-900 text-white">
        ...
        <section id="services" className="scroll-mt-20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="glass rounded-2xl p-8 hover:scale-105 transition-transform duration-300">
              <h3 className="text-2xl font-bold mb-4 text-brand-600 dark:text-brand-400">
                Process Automation
              </h3>
